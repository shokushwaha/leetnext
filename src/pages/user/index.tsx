        ...
        <>
            <div className='bg-slate-200 min-h-screen'>
                ...
                <motion.div
                    ...
                    className='flex  w-1/3 mx-auto items-center gap-4 bg-slate-100 mt-4 px-4 py-2'>
                    ...
                    loading ?
                        ...
                        <div className='grid grid-cols-2 gap-4 w-4/5 mx-auto justify-center px-4 py-4 mt-10'>
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.4 }}
                                className='bg-gradient-to-r from-green-200 via-green-300 to-green-400 w-2/3 px-4 py-2 rounded-md shadow'>
                            ...
                            <motion.div
                                ...
                                exit={{ opacity: 0, x: "2000px" }}
                                transition={{ duration: 0.4 }}
                                className='bg-gradient-to-r from-red-200 via-red-300 to-red-400 w-2/3 px-4 py-2 rounded-md shadow'>
                            ...
                            <motion.div
                                ...
                                exit={{ opacity: 0, x: "-2000px" }}
                                transition={{ duration: 0.4 }}
                                className='bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-400 w-2/3 px-4 py-2 rounded-md shadow '>
                            ...
                            <motion.div
                                ...
                                exit={{ opacity: 0, x: "2000px" }}
                                transition={{ duration: 0.4 }}
                                className='bg-gradient-to-r from-cyan-200 via-cyan-300 to-cyan-400 w-2/3 px-4 py-2 rounded-md shadow'>
