...
const Timer: React.FC<TimerProps> = () => {
    ...
    return (
        <>
            {showTimer ? (
                <div className='flex items-center space-x-2 bg-neutral-400 p-1.5 cursor-pointer rounded hover:bg-neutral-600'>
                ...
                <div
                    className='flex items-center p-1 h-8 hover:bg-neutral-900 rounded cursor-pointer'
