        ...
        <div className='text-white z-40'>
            <div aria-modal='true' role='dialog' className='fixed inset-0 overflow-y-auto z-modal'>
                <div className='flex min-h-screen items-center justify-center px-4'>
                    ...
                    >
                        <div className='fixed inset-0 bg-neutral-800 opacity-60'></div>
                    </div>

                    <div className='my-8 inline-block min-w-full transform rounded-[13px] text-left transition-all bg-neutral-800 md:min-w-[420px] shadow-level4 shadow-lg p-0  w-[600px] !overflow-visible opacity-100 scale-100'>
